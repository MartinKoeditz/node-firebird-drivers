...
export const op_prepare2 = 51;
export const op_event = 52;
export const op_connect_request = 53;
export const op_aux_connect = 54;
...
export const op_set_cursor = 69;
export const op_info_sql = 70;
export const op_dummy = 71;
export const op_execute2 = 76;
export const op_sql_response = 78;
export const op_rollback_retaining = 86;
export const op_drop_database = 81;
export const op_info_blob = 43;
export const op_que_events = 48;
export const op_cancel_events = 49;
export const op_cancel = 91;
...
export const STATEMENT_FLAG_HAS_CURSOR = 0x1;
